...
Enhanced version with better accuracy and detailed epoch logging
"""
...
print("=" * 80)
print("SOLVE4 ENHANCED — GCN vs GraphSAGE vs GAT")
print("=" * 80)
...
# Binary sentiment
df["sentiment_bin"] = (df["sentiment_predicted"] > 0).astype(int)
...
results = {}
HIDDEN = 512
LAYERS = 5    # Increased from 4
LR = 0.001    # Reduced for more stable training
EPOCHS = 13
...
for gnn in ["GCN", "SAGE", "GAT"]:
    ...
    model = EdgeGNN(
        ...
        HIDDEN, LAYERS, 0.3  # Added dropout
    ).to(DEVICE)
    ...
    torch.save(best_state, f"best_{gnn}_solve4_enhanced.pt")
